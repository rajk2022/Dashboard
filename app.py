...
with tab_dash:
    ...
    default_legend = dict(bgcolor="rgba(0,0,0,0)", font=dict(size=10))

    # ── MASTER CHART — TOP ────────────────────────────────────────────────
    st.markdown('<div class="section-hdr master-hdr">📈  Master Overview — All Programs Trend</div>', unsafe_allow_html=True)
    ...
    with c_left:
        ...
        fig_trend = px.line(trend_df, x="Period", y="Certifications", color="Program",
                            ...
                            markers=True)
        fig_trend.update_layout(**base_layout, height=340,
    ...
    with c_right:
        ...
        fig_dept.update_layout(**base_layout, height=340, coloraxis_showscale=False,
    ...
    for col, prog in zip(cols, bronze_progs):
        ...
        fig.update_layout(**base_layout, height=220, legend=default_legend,
    ...
    with c1:
        ...
        fig_tier.update_layout(**base_layout, height=280, legend=default_legend,
